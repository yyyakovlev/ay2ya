...
urlpatterns = [
    ...
    path("password-reset/", include("apps.myauth.urls")),
    path("password-reset/done/", include("apps.myauth.urls")),
    path("reset/<uidb64>/<token>/", include("apps.myauth.urls")),
    path("reset/done/", include("apps.myauth.urls")),
    path("password-change/", include("apps.myauth.urls")),
    path("password-change/done/", include("apps.myauth.urls")),
